...
const BROWSE_ORIGIN = "https:" + "//" + ["www", "ishugui", "com"].join(".");
const BROWSE_URL = BROWSE_ORIGIN + "/browse";

const CHANNELS = [
  { id: "male", label: "男频", tab: "男频", url: BROWSE_URL },
  { id: "female", label: "女频", tab: "女频", url: BROWSE_URL + "/on3" },
];

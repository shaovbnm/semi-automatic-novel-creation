...
const WEB_BASE = "https:" + "//" + ["manage", "zhangwenpindu", "cn"].join(".");
const API_BASE = "https:" + "//" + ["ms", "zhangwenpindu", "cn"].join(".");
const BOOKLIST_URL = WEB_BASE + "/books/booklist";
const PAGE_SIZE = 20;
...
function main() {
  ...
  if (!token) {
    ...
    console.log(`  → 请先在 Chrome 中打开 ${WEB_BASE} 并登录`);
